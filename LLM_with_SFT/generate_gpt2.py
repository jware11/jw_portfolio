...
This is a modified version of the provided generate.py file. 

This is modified to import the GPT2 model and tokenizer, and match input text to the SFT example. 
...
print('GPT2 Test Run with input: ', initial_text)
